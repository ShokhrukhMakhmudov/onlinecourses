...
export default function AuthModal() {
  ...
  const { login: loginStatus } = useUserStatus();
    ...
    <>
      ...
      {isModalOpen && (
        <div
          ...
          className={`overlay modal pointer-events-auto bg-primary/50 overlay-open:opacity-100 overlay-open:backdrop-blur-md modal-middle open opened`}
          role="dialog"
          tabIndex={100}
          // onClick={closeModal}
        >
          <div
            className="modal-dialog overlay-open:opacity-100"
            onClick={(e) => {
              e.stopPropagation();
            }}>
            <div className="modal-content">
              ...
              <div className="modal-body">
                <nav
                  ...
                  <button
                    type="button"
                    className={`btn btn-text active-tab:bg-primary active-tab:text-white hover:text-primary active-tab:opacity-100 opacity-50 hover:bg-primary/20 ${
                      activeTab === "tab-login" ? "active" : ""
                    }`}
                        ...
                        <div>
                          ...
                          <span className="label">
                            <span className="label-text-alt">
                              Ushbu raqam oraqali operatorlar siz bilan
                              bog'lanadi.
                            </span>
                          </span>
                        </div>
